...
=== "Narrative"
    ...
    - **Clinical observation in affected individual(s) (CLN_AFF)** (`CLN_AFF`, score 2.0) — Affected probands (illustrative). Proband 1's confirmed de novo is captured separately under CLN_DNV; LOC_PHE also applicable (>82% yield).
    - **Splicing (SPL)** (`SPL`, score 4.0) — Splicing evidence (PFD, illustrative).
      - `SPL_PRD` (score 4.0) — In-silico splice prediction.
...
=== "Semi-structured"
    ...
    Statement
      proposition:
        subject (VBC): NF1 c.3496G>C (p.Gly1166Arg)
