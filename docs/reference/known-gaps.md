...
| Disease Allele Frequency Threshold (DAFT) | POP | Three derivation methods per [Supplementary Material 3](https://docs.google.com/document/d/1XON2eq4HSM-guWlqitEnb8PghY0quNbA7_1WmmxvLj8/edit) (calculator / binning / pathogenic-variants). See [Population (POP)](../workflows/hod/pop.md#the-shape-of-the-remaining-work). |
