...
| **Statement / Proposition / Evidence Item** | VA-Spec core entities. An *Evidence Line* is a `Statement` nested via `hasEvidenceLines` (not a distinct class in 1.1.0-ballot.2026-09). See [Collecting the evidence](../collecting/index.md) for the nesting shape and the [VA-Spec community profile](va-spec-profile.md) for the class/property names. |
