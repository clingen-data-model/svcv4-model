...
| **Statement / Proposition / Evidence Line / Evidence Item** | VA-Spec core entities. See [Collecting the evidence](../collecting/index.md) for the nesting shape and the [VA-Spec community profile](va-spec-profile.md) for the class/property names. |
