...
<pre class="appl-json appl-full">
{
  ...
  <span class="j-key appl-o">"gene_disease_validity"</span>: <span class="j-str">"..."</span>,
  <span class="j-key appl-r">"case"</span>: {
    ...
    <span class="j-key appl-r">"testing"</span>: {
      ...
      <span class="j-key appl-o">"non_genetic_etiology_excluded"</span>: <span class="j-str">"..."</span>
    },
    ...
    <span class="j-key appl-c">"compound_het_variant"</span>: {
      ...
      <span class="j-key appl-o">"co_occurrence_likelihood"</span>: <span class="j-str">"..."</span>
    },
